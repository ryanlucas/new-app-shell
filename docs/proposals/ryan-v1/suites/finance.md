# Finance  `finance` *[touched: renameSuite, mergeSuite]*
...
| Banking *[mergeSuite]*| `/banking` | Full, Partial(banking_admin) | `BANKING` | — | locked → full, partial · SidenavBanking | — | — | `app/cross_sell/unpurchased_sku/unpurchased_sku_nav_items.py:441` |
